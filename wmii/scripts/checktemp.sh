...
HARDDISKB=$(sudo hddtemp /dev/sdb|awk '{print $3}'|tr -d "C")
HARDDISKC=$(sudo hddtemp /dev/sdc|awk '{print $4}'|tr -d "C")
echo -e "C0: $COREONE° C1: $CORETWO° C2: $CORETHREE° C3: $COREFOUR° ${color}Gfx: $GFX° HDA: $HARDDISKA HDB: $HARDDISKB HDC: $HARDDISKC"
