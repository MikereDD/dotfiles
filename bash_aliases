...
# urxvt quick aliases
alias sshell="urxvt -name 'HS shell' &"
alias cshell="urxvt -name 'CP shell' &"
alias fmshell="urxvt -name 'FM shell' &"
alias sushell="urxvt -name 'SU shell' &"
alias vshell="urxvt -name 'VE shell' &"
