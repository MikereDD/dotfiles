...
#echo "Finished with Audio Conversion"/VIDEO_TS/'

## Change
##add rip path here
RPATH='/mnt/p2/rip/drip' 

## Change
#Film Title
TITLE="Death_Note_Vol.1-ep01[2006]dvdrip(reDD)" 
...
#mp4 conversion with MP4Box
##############
#
echo "Creating MP4 File"
sleep 2

MP4Box -fps 29.97 -chap chapters.txt\
       -add $RPATH/$TITLE.264\
       -add $RPATH/$TITLE-1.aac\
