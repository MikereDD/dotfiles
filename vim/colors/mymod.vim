" sadNgrey
" Author:  MikereDD
" URL:     http://github.com/MikereDD/home/blob/master/vim/colors/mymod.vim
...
set t_Co=256
let g:colors_name = "mymod"

" Basic Layout {{{

hi Normal          ctermfg=240   ctermbg=233   cterm=NONE
hi Folded          ctermfg=238   ctermbg=232   cterm=NONE
hi CursorLine      ctermfg=240   ctermbg=232   cterm=NONE
